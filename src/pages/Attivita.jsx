              ...
              <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                  ...
                  <div className="space-y-12">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
                      {courses.map((course) => (
                        <div
                          key={course.id}
                          className="bg-white/80 rounded-2xl shadow-md hover:shadow-2xl border border-gray-100 transition-all duration-300 hover:scale-[1.02] flex flex-col justify-between p-4 sm:p-6"
                        >
                          {/* Immagine */}
                          ...
                          <div className="mt-auto flex flex-col sm:flex-row justify-center gap-2 sm:gap-3 pt-4 border-t border-gray-100">
                            ...
                            <Link
                              to="/contatti"
                              className="bg-purple-600 text-white px-4 sm:px-6 py-2 rounded-full font-medium hover:bg-purple-700 transition-colors text-xs sm:text-sm"
                            >
                ...
                {activeTab === 'eventi' && (
                  <div className="space-y-12">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
                      {events.map((event) => (
                        <div key={event.id} className="bg-white/80 rounded-2xl shadow-md hover:shadow-2xl border border-gray-100 transition-all duration-300 hover:scale-[1.02] flex flex-col justify-between p-4 sm:p-6">
                          {/* Immagine */}
                          <div className="w-full h-40 sm:h-48 mb-4 rounded-lg overflow-hidden">
                            <ImageWithFallback
                              src={event.image_url}
                        ...
                        <div key={week.id} className="bg-white/80 rounded-2xl shadow-md hover:shadow-2xl border border-gray-100 transition-all duration-300 hover:scale-[1.02] flex flex-col justify-between p-4 sm:p-6">
                          ...
                          <div className="flex flex-col flex-grow text-center">
                            ...
                            <div className="space-y-2 mb-5">
                              ...
                              <div className="chip chip-purple">
                                <i className="bi bi-tag mr-2"></i>
                                <span className="truncate">{week.type}</span>
                              </div>
                              <div className="chip chip-green">
                                <i className="bi bi-geo-alt mr-2"></i>
