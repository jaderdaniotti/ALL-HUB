...
// Componente per la modale di conferma eliminazione
export const ConfirmDeleteModal = ({ isOpen, onClose, onConfirm, itemType, itemTitle }) => {
  ...
  const getItemTypeText = (type) => {
    switch (type) {
      ...
      case 'studyWeek': return 'settimana studio';
      ...
      <div className="bg-white rounded-xl shadow-2xl p-6 max-w-md w-full mx-4">
        <div className="text-center">
          ...
          <p className="text-sm text-gray-600 mb-6">
            Sei sicuro di voler eliminare il {getItemTypeText(itemType)} <strong>"{itemTitle}"</strong>?
            <br />
